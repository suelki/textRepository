...
<%
	...
	//로그인 되어있지 않으면 null(attribute에 lobinUser라는 키값에 해당하는 데이터가 없으니까)
...
<style>
    ...
    .menu a{
        ...
        font-size: 20px;
        font-weight: bold;
        display: block;/*black으로 지정후 with/height 100%하면 해당 블럭에 꽉차게 설정 가능*/
        width: 100%;
        height: 100%;
        line-height: 50px;
        margin-left: 10px;
...
<div class="login-area">
    ...
    <script>
    	function enrollPage(){
    		...
    		//단순 페이지 이동이여도 servlet을 거쳐서 매핑값이 노출되어 갈수 있도록 작업하기.
